...
G4VPhysicalVolume *PrtDetectorConstruction::Construct() {
  ...
  if (fEvType == 1) { // focusing prism
    ...
    fPrismShift = G4ThreeVector((fPrizm[2] + fPrizm[3]) / 4. - 0.5 * fPrizm[3], 0,
                                0.5 * (dirclength + fPrizm[1]) + fLens[2]);
...
void PrtDetectorConstruction::DefineMaterials() {
  ...
  double en_Sapphire[] = {
    1.02212, 1.05518, 1.09045, 1.12610, 1.16307, 1.20023, 1.23984, 1.28043, 1.32221, 1.36561,
    1.41019, 1.45641, 1.50393, 1.55310, 1.60393, 1.65643, 1.71059, 1.76665, 1.82437, 1.88397,
    1.94576, 2.00946, 2.07504, 2.14283, 2.21321, 2.28542, 2.36025, 2.43727, 2.51693, 2.59924,
    2.68480, 2.77245, 2.86337, 2.95693, 3.05379, 3.15320, 3.25674, 3.36273, 3.47294, 3.58646,
    3.70433, 3.82549, 3.94979, 4.07976, 4.21285, 4.35032, 4.49380, 4.64012, 4.79258, 4.94946,
    5.11064, 5.27816, 5.44985, 5.62797, 5.81266, 6.00407, 6.19920};
  double ref_Sapphire[] = {
